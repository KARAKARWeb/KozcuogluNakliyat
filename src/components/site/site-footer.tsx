        ...
        <div className="mx-auto grid max-w-[1440px] gap-8 px-4 md:grid-cols-2 md:px-6 lg:grid-cols-6 lg:px-8">
          ...
          <div>
            ...
            <address className="not-italic space-y-2 text-sm text-gray-400">
              <div><strong className="text-white">Müşteri Hizmetleri:</strong><br/><a href="tel:4447436" className="transition hover:text-white">444 7 436</a></div>
              <div><strong className="text-white">WhatsApp:</strong><br/><a href="https://wa.me/905321384979" className="transition hover:text-white">0532 138 49 79</a></div>
              <div><strong className="text-white">Telefon:</strong><br/><a href="tel:02164945337" className="transition hover:text-white">0216 494 53 37</a></div>
              <div><strong className="text-white">E-Posta:</strong><br/><a href="mailto:info@kozcuoglunakliyat.com.tr" className="transition hover:text-white">info@kozcuoglunakliyat.com.tr</a></div>
              <div><strong className="text-white">Adres:</strong><br/>Kaynarca Mah. Bahattin Veled Cad. No:37 34890 Pendik / İstanbul</div>
            </address>
          </div>
        </div>
      </div>
